const mapping = {
  ...
  'Locket': ['Gold', 'com.dung16908.premium.yearly']
};
...
const premiumInfo = {
  ...
  original_purchase_date: "2025-09-16T01:04:17Z",
  purchase_date: "2025-09-16T01:04:17Z",
  store: "app_store"
};
const entitlementInfo = {
  grace_period_expires_date: null,
  purchase_date: "2025-09-16T01:04:17Z",
  product_identifier: "com.dung16908.premium.yearly",
  expires_date: "2999-12-18T01:04:17Z"
};
const match = Object.keys(mapping).find(e => ua.includes(e));
if (match) {
  let [entKey, subKey] = mapping[match];
  let finalSubKey = subKey || "com.dung16908.premium.yearly";
  ...
  obj.subscriber.subscriptions["com.dung16908.premium.yearly"] = premiumInfo;
